...
N64_LDFLAGS = -L$(N64_ROOTDIR)/mips64-elf/lib -ldragon -lm -ldragonsys -Tn64.ld --gc-sections
...
%.elf: $(N64_ROOTDIR)/mips64-elf/lib/libdragon.a $(N64_ROOTDIR)/mips64-elf/lib/libdragonsys.a $(N64_ROOTDIR)/mips64-elf/lib/n64.ld
	@mkdir -p $(BUILD_DIR)
	@echo "    [LD] $@"
	$(N64_CXX) -o $@ $(filter-out $(N64_ROOTDIR)/mips64-elf/lib/n64.ld,$^) -lc $(patsubst %,-Wl$(COMMA)%,$(LDFLAGS)) -Wl,-Map=$(BUILD_DIR)/$(notdir $(basename $@)).map
	$(N64_SIZE) -G $@
